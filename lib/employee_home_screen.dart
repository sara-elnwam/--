      ...
      builder: (BuildContext context) {
        return Directionality(
          ...
          child: AlertDialog(
            ...
            content: Text("هل أنت متأكد أنك تريد تسجيل الخروج من التطبيق؟", style: TextStyle(color: Colors.grey.shade700)),
            actions: [
              TextButton(
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: Center(child: Text(_currentTitle, style: TextStyle(fontSize: 24, color: Colors.grey.shade400))),
      ),
    );
  }
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Center(child: Image.asset('assets/full_logo.png', height: 80, errorBuilder: (c, e, s) => Icon(Icons.school, size: 60, color: primaryOrange))),
          ),
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: 80,
                    child: _buildSidebarItem(Icons.logout, "تسجيل الخروج", color: Colors.red, isLogout: true),
                  ),
                ],
              ),
            ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          title: Text(title, style: TextStyle(color: isSelected ? Colors.white : (color ?? darkBlue), fontWeight: isSelected ? FontWeight.bold : FontWeight.normal, fontSize: 14)),
